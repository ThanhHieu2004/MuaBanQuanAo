...
<body>
	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="offcanvas__nav__option">
			<a href="#" class="search-switch"><img src="../template/web/img/icon/search.png"
				alt=""></a> <a href="#"><img src="../template/web/img/icon/heart.png" alt=""></a>
	...
	<section class="hero">
		<div class="hero__slider owl-carousel">
			<div class="hero__items set-bg" data-setbg="../template/web/img/hero/hero-1.jpg">
				<div class="container">
					<div class="row">
